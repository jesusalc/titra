...
do
    ...
    "Build Titra")
		...
		#	echo "sed at macOS";
		#	sed -i '' 's/api\.versionsFrom/\/\/api.versionsFrom/' ~/repos/Titra/packages/meteor-useraccounts-core/package.js
		#else
		#	echo "sed at ${OSTYPE}"
		#	sed -i 's/api\.versionsFrom/\/\/api.versionsFrom/' ~/repos/Titra/packages/meteor-useraccounts-core/package.js
		#fi
		...
		# Remove legacy webbroser bundle, so that Titra works also at Android Firefox, iOS Safari, etc.
		rm -rf .build/bundle/programs/web.browser.legacy
		#Removed binary version of bcrypt because of security vulnerability that is not fixed yet.
		#https://github.com/Titra/Titra/commit/4b2010213907c61b0e0482ab55abb06f6a668eac
		#https://github.com/Titra/Titra/commit/7eeabf14be3c63fae2226e561ef8a0c1390c8d3c
		#cd ~/repos/Titra/.build/bundle/programs/server/npm/node_modules/meteor/npm-bcrypt
    ...
    "Run Meteor for dev on http://CUSTOM-IP-ADDRESS:PORT")
		...
		read IPADDRESS
		echo "On what port you would like to run Titra?"
		read PORT
